...
fn format_the_query(page_number : u16, rows_per_page : u16, filter_type : &String, filter_query : &String) -> String {
...
pub fn get_filtered_orders_by_page_sql(page_number : u16, rows_per_page : u16, filter_type : &String, filter_query : &String, pool : &mut MutexGuard<PooledConn>) -> mysql::Result<Vec<FormattedObject>, Error> {
